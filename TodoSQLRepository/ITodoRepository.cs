...
namespace Interfaces
{
    public interface ITodoRepository
    {
        ...
        /// Throw TodoAccessDeniedException with appropriate message if user is not the owner of the Todo item
        /// </summary>
        /// <param name="todoId">Todo Id</param> 
        ...
        /// <summary>
        /// Gets all incomplete ToDoObjects in database for user.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Gets all ToDoItem objects in database for user that apply the filter.
        /// </summary>
